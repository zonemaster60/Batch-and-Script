...
REM BFCPEEXE=C:\Users\zonem\Documents\BatchScript Projects\2caf\2CAF.exe
...
rem ***********
Call :show_me 0 0
Call :count_num 1 "Analyze: Scan the component store for errors."
...
Call :count_num 1 "ResetBase: This will reset the component stores."
